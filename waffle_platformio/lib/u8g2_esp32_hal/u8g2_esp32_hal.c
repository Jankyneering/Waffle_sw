...
uint8_t u8g2_esp32_spi_byte_cb(u8x8_t* u8x8, uint8_t msg, uint8_t arg_int, void* arg_ptr)
{
	...
	switch (msg)
	{
		...
		{
			if (u8g2_esp32_hal.bus.spi.clk == U8G2_ESP32_HAL_UNDEFINED || u8g2_esp32_hal.bus.spi.mosi == U8G2_ESP32_HAL_UNDEFINED || u8g2_esp32_hal.bus.spi.cs == U8G2_ESP32_HAL_UNDEFINED)
			{
				break;
			}
			...
			dev_config.clock_speed_hz = u8g2_esp32_hal.clk_speed;
...
uint8_t u8g2_esp32_i2c_byte_cb(u8x8_t* u8x8, uint8_t msg, uint8_t arg_int, void* arg_ptr)
{
	...
	switch (msg)
	{
		...
		case U8X8_MSG_BYTE_INIT:
		{
			if (u8g2_esp32_hal.bus.i2c.sda == U8G2_ESP32_HAL_UNDEFINED || u8g2_esp32_hal.bus.i2c.scl == U8G2_ESP32_HAL_UNDEFINED)
			{
				break;
			}
			...
			ESP_LOGI(TAG, "clk_speed %lu", u8g2_esp32_hal.clk_speed);
			conf.master.clk_speed = u8g2_esp32_hal.clk_speed;
...
uint8_t u8g2_esp32_gpio_and_delay_cb(u8x8_t* u8x8, uint8_t msg, uint8_t arg_int, void* arg_ptr)
{
	...
	switch (msg)
	{
		...
		// If the pins for DC and RESET have been specified then we define those pins as GPIO outputs.
